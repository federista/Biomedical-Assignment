...
class MainApplication(tk.Frame):
    ...
    def __init__(self, parent, *args, **kwargs):
        ...
        self.check6.grid(row=8, column=0, padx=(0, 40), pady=30, sticky='w')
    ...
    def start(self):
        ...
        if os.path.isfile(self.drPath + "offset_custom.txt"):
            ...
            start_reaching(self.drPath, self.lbl_tgt, self.num_joints, self.joints, self.dr_mode,self.check_mouse)
...
if __name__ == "__main__":
    ...
    win = tk.Tk()
    win.title("BIOMEDICAL ASSIGNMENT")
