...
class MainApplication(tk.Frame):
    ...
    def __init__(self, parent, *args, **kwargs):
        ...
        self.calib_duration = 30
        self.timeout = self.calib_duration
        ...
        self.check6 = Checkbutton(win, text="Mouse Control", variable=self.check_mouse)
        self.check6.config(font=("Arial", self.font_size))
        self.check6.grid(row=0, column=7, padx=(0, 40), pady=30, sticky='w')
    ...
    #def Mouse_control(self):
        #V_Selected = self.VirtualMouse.get()
        #R_Selected = self.RealMouse.get()
        #if V_Selected == True:
